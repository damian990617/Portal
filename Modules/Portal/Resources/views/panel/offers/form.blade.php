        ...
        <div class="container-fluid page-content__top-content">
            ...
            <div class="page-content__top-buttons d-flex">
                @if(isset($edit) && $edit == 1)
                    <button type="submit" class="btn btn--delete" form="offerForm">@lang('admin::main.delete')</button>
                    <button type="submit" class="btn btn--edit" form="offerForm">@lang('admin::main.update')</button>
                @elseif(!$item->id)
                    <button type="submit" class="btn btn--create" form="offerForm">@lang('admin::main.save')</button>
                @else
